...
const RegRightSide = () => {
 ...
 <div className="glass-surface rounded-xl relative overflow-hidden border border-outline-variant/30 flex flex-col h-full neon-border transition-transform duration-200 ease-out">
 ...
 <input
 className="w-full bg-surface-container-lowest/30 border border-on-surface rounded-lg py-md pl-md pr-10 text-on-surface placeholder:text-primary/50 focus:outline-none transition-all duration-300 font-code-sm focus:ring-0 focus:border-primary/50 focus:bg-primary/5 "
...
"neon-glow-active",
 ...
 <div className="relative group">
 <input
 className="w-full bg-surface-container-lowest/30 border border-on-surface rounded-lg py-md pl-md pr-12 text-on-surface placeholder:text-primary/50 focus:outline-none transition-all duration-300 font-code-sm focus:ring-0 focus:border-secondary/50 focus:bg-secondary/5 "
 placeholder="••••••••••••"
 type="password"
 onFocus={(e) =>
 e.target.parentElement.classList.add("neon-glow-active")
