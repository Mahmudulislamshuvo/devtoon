...
const DevUsernamePage = () => {
 ...
 <MdAutoAwesome className="text-3xl text-tertiary animate-bounce"/>
 </div>
 <div className="space-y-md">
 ...
 <div className="flex items-center justify-center min-h-[60vh] w-full px-4">
 <div className="glass-card border border-red-500/20 p-lg md:p-xl rounded-2xl w-full text-center space-y-md backdrop-blur-md transition-all duration-300">
