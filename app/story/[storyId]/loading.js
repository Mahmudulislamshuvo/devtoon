...
export default function LoadingStory() {
 ...
 {/* Book Area */}
 <div className="w-[315px] md:w-[450px] lg:w-[900px] h-[400px] md:h-[600px] bg-surface-container/40 border border-outline-variant/30 animate-pulse rounded-r-xl rounded-l-md flex items-center justify-center">
